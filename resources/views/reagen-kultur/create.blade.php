...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Form Tambah Data Reagen Kultur</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="p-10">
                    <form method="post" class="user" action="{{ url('reagena-kultur/create') }}" enctype="multipart/form-data">
                        @csrf
