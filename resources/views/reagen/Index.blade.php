...
@section('content')
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-2">
                        ...
                        <div class="card-body">
                            <div class="my-2">
                                <a href="{{url('reagena/create')}}" class="btn btn-success btn-icon-split">  
                                    <span class="text">Tambah Data</span>
                                </a>     
                                <a href="{{url('exp_excel')}}" class="btn btn-primary btn-icon-split">  
                                    <span class="text">Export Data</span>
                                </a>
                                <form action="{{ url('import') }}" class="user"  method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                          ...
                                          <td>{{$dt->volume_stok}}</td>
                                            @if(auth()->user()->level == 2)
                                            <td>
                                                <a href="{{ url('reagena/edit/'.$dt->id_reagen) }}" class="btn btn-primary mb-2">  
                                                    <i class="fa fa-edit"></i>
                                                    Edit    
                                                </a>
                                                <a href="{{ url('reagena/delete/'.$dt->id_reagen) }}" class="btn btn-danger mb-2">  
                                            ...
                                            @elseif(auth()->user()->level == 3)
                                            <td>
                                                <a href="{{ url('reagenu/edit/'.$dt->id_reagen) }}" class="btn btn-primary mb-2">  
                                                    <i class="fa fa-edit"></i>
                                                    Edit    
                                                </a>
                                            </td>
