...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Form Edit Data Reagen Riset</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="p-10">
                    ...
                    <form method="post" class="user" action="{{ url('reagena/edit/' . $data->id_reagen) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <form method="post" class="user" action="{{ url('reagenu/edit/' . $data->id_reagen) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="">Metode Analisis</label>
