            ...
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                <div class="py-12 bg-blue-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                    <div class="cursor-pointer flex items-center">
                        <div>
                            <svg class="w-10 text-blue-500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 225 225" style="enable-background:new 0 0 225 225;" xml:space="preserve">
                                <style type="text/css">
                ...
                <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    <h2 class="text-center text-4xl text-blue-600 font-display font-semibold lg:text-left xl:text-5xl
                    ...
                    <div class="mt-12">
                        <form action="{{ url('login') }}" method="post">
                            @csrf
                            <div>
                                <div class="text-sm font-bold text-gray-700 tracking-wide">Alamat Email </div>
                                <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-blue-500" type="email" name="email" placeholder="sipp@gmail.com">
                            </div>
                            <div class="mt-8">
                        ...
                        Tidak punya akun ? <a href="register" class="cursor-pointer text-blue-600 hover:text-blue-800">Daftar</a>
                        </div>
                    </div>
                </div>
            </div>
