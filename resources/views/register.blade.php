                    ...
                    <div class="mt-12">
                        <form action="{{ url('register') }}" method="post">
                            ...
                            <div>
                                ...
                                <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-blue-500" type="text" name="name_user" placeholder="Fahrizal Abdul Fatah">
                            </div>            
                            <div>
                                <div class="mt-4 text-sm font-bold text-gray-700 tracking-wide">Alamat Email </div>
                                <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-blue-500" type="email" name="email" placeholder="fahrizal@gmail.com">
                            </div>
                            <div class="mt-4">
